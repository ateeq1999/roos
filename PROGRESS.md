...
- [x] Task 35: Alpha release on crates.io — done — workspace metadata (keywords/categories/homepage/documentation), all 11 crates inherit via workspace, README expanded, cargo package roos-core verifies clean (79.5 KiB, 14 files)
